...
export const CATEGORIES: Category[] = [
  {
    id: 'studio', label: 'Create', name: 'Design with us', href: '/studio',
  ...
  {
    id: 'habitus', label: 'Live', name: 'Furniture collections', href: '/habitus',
  ...
  {
    id: 'residences', label: 'Explore', name: 'Properties by Muem', href: '/residences',
